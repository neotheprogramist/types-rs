...
impl Transaction {
    ...
    // pub fn verify_hash(&self, chain_id: Felt) -> bool {
    //     self.variant.verify_hash(chain_id, self.hash)
    // }

    pub fn version(&self) -> Felt {
        match &self.variant {
            TransactionVariant::DeclareV0(_) => Felt::ZERO,
            TransactionVariant::DeclareV1(_) => Felt::ONE,
            TransactionVariant::DeclareV2(_) => Felt::TWO,
            TransactionVariant::DeclareV3(_) => Felt::THREE,
            // TransactionVariant::DeployV0(_) => Felt::ZERO,
            // TransactionVariant::DeployV1(_) => Felt::ONE,
            TransactionVariant::DeployAccountV1(_) => Felt::ONE,
            TransactionVariant::DeployAccountV3(_) => Felt::THREE,
            TransactionVariant::InvokeV0(_) => Felt::ZERO,
            TransactionVariant::InvokeV1(_) => Felt::ONE,
            TransactionVariant::InvokeV3(_) => Felt::THREE,
